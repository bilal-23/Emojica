...
const NotFound = () => {
  return (
    <>
      <Head>
        <title>Emojica | 404</title>
      </Head>
      <div className="w-full h-screen overflow-hidden top-0 flex flex-col lg:flex-row items-center justify-center space-y-16 lg:space-y-0 space-x-8 2xl:space-x-0 bg-[#edf2f7]">
